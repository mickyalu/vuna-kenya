...
export const TERMS_BODY = [
  ...
  'A Vuna Gift is a whole-shilling payment to the person you choose. It is credited to that profile after the M-Pesa callback. It is not added to your protocol lock.',
