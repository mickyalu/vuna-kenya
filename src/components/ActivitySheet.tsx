...
export function ActivitySheet({ pillar, onClose, onPick, onOther }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end justify-center bg-black/55">
      ...
      <div className="relative w-full max-w-[430px] rounded-t-[28px] border-t border-vuna-border bg-[#1a1a1a] px-5 pb-[max(1.25rem,env(safe-area-inset-bottom))] pt-5">
        <div className="mb-4 flex items-start justify-between gap-3">
          ...
          <button
            type="button"
            onClick={onClose}
            className="flex h-9 w-9 items-center justify-center rounded-full bg-[#2a2a2a] text-vuna-muted"
