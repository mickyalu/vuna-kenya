        ...
        <div className="rounded-2xl border border-vuna-border bg-vuna-card p-3">
          <div className="flex items-center gap-3">
            ...
            <div className="min-w-0 flex-1">
              <p className="text-[15px] font-semibold text-white">Invite & Sync Contacts</p>
              <p className="text-[12px] text-vuna-muted">
                {whatsappConnected ? 'WhatsApp tribe proof on' : 'Enable Tribe Social Proof'}
              </p>
            </div>
            {whatsappConnected ? (
              <button
                ...
                className="rounded-full bg-vuna-lime px-4 py-2 text-[13px] font-semibold text-black"
              >
                Invite
              </button>
            ) : (
